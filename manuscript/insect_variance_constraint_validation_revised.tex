...
this paper are version-controlled in the repository
\texttt{insect-variance-constraint-validation}. \textbf{This repository
is not yet published to a public remote at the time of this revision};
no GitHub URL is stated here rather than inventing one, and this should
be added once the repository is made public. The full research chronology:
...
documentation. This repository's own license (for its original code and
documentation) is to be finalized before any public release.
